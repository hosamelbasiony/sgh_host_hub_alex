        ...
        try {
            ...
            for ( var x=0; x<data.length; x++) {
                ...
                if ( b == ACK ) {
                    ...
                    localBuffer = localBuffer.replace(/\x02[0-9]/g, '').replace(/\x17..\x0a/g, '');
                	...
                	fileSystem.appendFile(this.inDir, JSON.stringify(messages, undefined, 2), err => {}); 

                } else if ( b.charCodeAt(0) > 31 || b == LF || b == CR ) {}
            }
        } catch(ex) {
        	console.error(ex);
        }
