...
let testRawResult = `H|\\^&|||U-WAM^00-03^11001^^^^BE198113||||||||LIS2-A2|20151211180253${CR}
P|1|||||||U${CR}
O|1|12345678901234||^^^C-PH\\^^^C-LEU\\^^^C-NIT\\^^^C-PRO\\^^^C-GLU\\^^^C-KET\\^^^C-URO\\^^^CBIL\\^^^C-COLOR\\^^^C-ColorRANK\\^^^C-CLOUD\\^^^C-CRE\\^^^C-ALB\\^^^C-P/C\\^^^C-A/C\\^^^CS.G.(Ref)\\^^^C-BLD\|R||20151211180241||||N|||20151211180247|*||||||||||F${CR}
R|1|^^^C-PH^A^1^S^0002^01|7.5^RAW|||N||||^^admin^administrator||20151110105603|UC_3500${CR}
R|2|^^^C-PH^A^1^S^0002^01|7.5^MAINFORMAT|||N||||^^admin^administrator||20151110105603|UC_3500${CR}
R|3|^^^C-LEU^A^1^S^0002^01|500^RAW|/μ l||N||||^^admin^administrator||20151110105603|UC_3500${CR}
R|4|^^^C-LEU^A^1^S^0002^01|3+^MAINFORMAT|||N||||^^admin^administrator||20151110105603|UC_3500${CR}
R|5|^^^C-S.G.(Ref)^A^1^S^0002^01|1.009^RAW|||N||||^^admin^administrator||20151110105603|UC_3500${CR}
R|6|^^^C-S.G.(Ref)^A^1^S^0002^01|1.009^MAINFORMAT|||N||||^^admin^administrator||20151110105603|UC_3500${CR}
R|7|^^^C-BLD^A^1^S^0002^01|0.75^RAW|mg/dL||N||||^^admin^administrator||20151110105603|UC_3500${CR}
R|8|^^^C-BLD^A^1^S^0002^01|3+^MAINFORMAT|||N||||^^admin^administrator||20151110105603|UC_3500${CR}
L|1|N${CR}`;
