...
export const getAge = ( dateStringFrom, dateStringTo = false)  => {
    ...
    if ( age.months != 0 && age.years <= 3 ) age.ageString += ' - ' + age.months + 'M';
    if ( age.days != 0 && age.months <= 6 && age.years < 1 ) age.ageString += ' - ' + age.days + 'D';

    if (age.ageString.substring(0, 2) == ' -' ) age.ageString = age.ageString.substring(3);
